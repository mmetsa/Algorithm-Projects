package mmetsa.sortingalgorithms;
...
public class IntSorting {
     ...
     * @param left left index for searching
     * @param right right index for searching
     * @param element element to search for
     * @return index of the element that was searched for
     */
    ...
    public static void binaryInsertionSort(int[] a) {
        for (int elementIndex = 1; elementIndex < a.length; elementIndex++) {
            int elem = a[elementIndex];
            int left = 0;
            int right = elementIndex - 1;
            int searchIndex = binarySearch(a, left, right, elem);
            System.arraycopy(a, searchIndex, a, searchIndex + 1, elementIndex - searchIndex);
            if(elem >= a[searchIndex]) {
                a[searchIndex + 1] = elem;
            } else {
                a[searchIndex] = elem;
            }
        }
    ...
    /**
     * Sort a part of the array uing quicksort method.
